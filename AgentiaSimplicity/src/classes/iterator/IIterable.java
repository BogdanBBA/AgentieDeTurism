...
/** 
 *  Provides the definition for the {@code getIterator()} method that should return a {@link IIterator} implementation for the 
 *  desired iteration type across {@link AgencyResource} objects.
 */
public interface IIterable
{
	/**
	 * Should return a {@link IIterator} implementation for the desired iteration type across {@link AgencyResource} objects.
	 * @param resources the list of concrete implementations of agency resources
